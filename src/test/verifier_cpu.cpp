...
template<AnySupportedIntegral T>
void test_verifier_cpu_run_a_range() {
    start_test(__func__);
...
template<AnySupportedIntegral T>
void test_verifier_cpu_job_control() {
    start_test(__func__);
...
template<AnySupportedIntegral T>
void test_verifier_cpu_detailed_metrics() {
    start_test(__func__);
...
void run_all() {
    ...
    test_verifier_cpu_basics<T>();
    test_verifier_cpu_run_a_range<T>();
    test_verifier_cpu_job_control<T>();
    test_verifier_cpu_detailed_metrics<T>();
}
