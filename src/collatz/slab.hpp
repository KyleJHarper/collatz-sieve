//
// This failed to work as expected, probably because of my limited knowledge around "operator new" vs "new"
// construction, which led to double-free or memory leaks.
//
